 ...
 *
 * OWASP A02 (Security Misconfiguration), and XSS defence in any client that
 * renders a response. Values live in config/cachewraith-template.php; the
 * defaults assume a JSON-only API and deny everything.
 */
